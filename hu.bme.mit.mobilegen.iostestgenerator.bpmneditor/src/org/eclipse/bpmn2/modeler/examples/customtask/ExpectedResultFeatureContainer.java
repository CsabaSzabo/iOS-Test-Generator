...
public class ExpectedResultFeatureContainer extends CustomTaskFeatureContainer {

	private final static String TYPE_VALUE = "ExpectedResult";
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.customTask1";

	public ExpectedResultFeatureContainer() {
	}
