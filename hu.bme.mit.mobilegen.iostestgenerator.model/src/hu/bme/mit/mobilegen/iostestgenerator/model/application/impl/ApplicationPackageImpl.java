...
public class ApplicationPackageImpl extends EPackageImpl implements ApplicationPackage {
	 ...
	 * @see hu.bme.mit.mobilegen.iostestgenerator.model.application.ApplicationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getApplication_Uielements() {
	 ...
	 * @generated
	 */
	public EAttribute getApplication_XcodeTestFolder() {
	 ...
	 * @generated
	 */
	public EAttribute getUIElement_AccessibilityLabel() {
	...
	public void createPackageContents() {
		...
		createEReference(applicationEClass, APPLICATION__UIELEMENTS);
		createEAttribute(applicationEClass, APPLICATION__XCODE_TEST_FOLDER);

		uiElementEClass = createEClass(UI_ELEMENT);
		createEAttribute(uiElementEClass, UI_ELEMENT__ACCESSIBILITY_LABEL);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getApplication_Uielements(), this.getUIElement(), null, "uielements", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getApplication_XcodeTestFolder(), ecorePackage.getEString(), "XcodeTestFolder", null, 0, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uiElementEClass, UIElement.class, "UIElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUIElement_AccessibilityLabel(), ecorePackage.getEString(), "accessibilityLabel", null, 0, 1, UIElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
