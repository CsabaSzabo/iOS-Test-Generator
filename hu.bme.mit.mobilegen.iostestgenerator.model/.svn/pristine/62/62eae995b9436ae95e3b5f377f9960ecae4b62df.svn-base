/**
 */
package hu.bme.mit.mobilegen.iostestgenerator.model.application.util;

import hu.bme.mit.mobilegen.iostestgenerator.model.application.*;
...
public class ApplicationAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.mobilegen.iostestgenerator.model.application.Application <em>Application</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.mobilegen.iostestgenerator.model.application.UIElement <em>UI Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
